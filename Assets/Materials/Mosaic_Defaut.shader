Shader "Unlit/Mosaic_Default"
{
	Properties
	{
	// Copyright Roberta Jane Bennett 08/11/17
	// Expects global texture2DArray named _my2darray to be assigned in script.
	// NEED TO REFACTOR AND MOVE TX2D TO A PROPERTY A-LA TOMOVIEW
	...
	// TO EMULATE: set magOn >0 to enable emulation.
	 _my2darray ("TARray", 2DArray) = "white" {} // 2DARRY HURRAY END THE GLOBAL MESS
	 _my2darray1 ("TARray 1", 2DArray) = "white" {} // 2DARRY HURRAY END THE GLOBAL MESS
