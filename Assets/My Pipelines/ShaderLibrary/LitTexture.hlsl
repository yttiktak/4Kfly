#ifndef MYRP_LITTEXTURE_INCLUDED
#define MYRP_LITTEXTURE_INCLUDED
...
struct VertexOutput {
	...
	float2 uv : TEXCOORD3; // why are you using texcoord0 for naormals?
...
VertexOutput LitTexturePassVertex (VertexInput input) {
	VertexOutput output;
...
float4 LitTexturePassFragment (VertexOutput input) : SV_TARGET {
	UNITY_SETUP_INSTANCE_ID(input);
...
#endif // MYRP_LITTEXTURE_INCLUDED